            ...
            <div>
                <div class="card-content white-text">
                    ...
                    <div className="statusDetails">
                                ...
                                return (
                                    (this.props.user.ble_devices[key].proximity || this.props.user.compliant.polling) ? `` :
                                        <span><i class="material-icons" style={{ color: '#f8bd0d' }}>warning</i>
                                            {this.userHelper.capitalizeFirstLetter(this.props.user.ble_devices[key].type)} Not Updating<br />
                                        </span>
                                )
                            })
                        }
                        ...
                        {this.userHelper.wifiConnectionStatus(this.props.user.device_status.connection_status)} <br/>
